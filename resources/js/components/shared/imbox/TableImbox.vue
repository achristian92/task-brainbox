<template>
    <div class="table-responsive">
        ...
        <table class="table align-items-center table-flush border-bottom-0" id="dtTableImbox">
            ...
            <tr v-for="(activity,index) in p_activities">
                ...
                <td>
                    <div v-if="showInputTimeReal !== index">{{ activity.duration }} h</div>
                    <div v-else>
                        <input type="text"
                               maxlength="5"
                               placeholder="00:00"
...
export default {
   ...
   methods: {
        ...
        canTakeAcions: function() {
            return this.p_tab === 'today' || this.p_tab ==='overdue'
        },
