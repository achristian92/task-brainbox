<div class="modal fade" id="modalEditTag" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form" id="form-edit-tag">
                <input type="hidden" id="tag_id">

                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-control-label" for="nametagInput">Nombre de la etiqueta</label>
                        <input type="text" class="form-control" id="nameEditTagInput" name="name" required>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" for="colorselectorEdit">Color de la etiqueta</label>
                        <select class="form-control" id="colorselectorEdit" name="color">
