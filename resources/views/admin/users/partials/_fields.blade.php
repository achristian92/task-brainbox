        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @include('shared.form.text',['name' => 'name', 'required'=> 1])
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-control-label">Apellidos</label>
                    @include('shared.form.text',['name' => 'last_name', 'required'=> 1])
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @include('shared.form.text',['name' => 'nro_document'])
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-control-label">Correo electrónico</label>
                    @include('shared.form.email',['name' => 'email', 'required'=> 1])
                </div>
            </div>
        </div>
        <div class="row">
