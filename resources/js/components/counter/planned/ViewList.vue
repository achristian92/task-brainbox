...
export default {
    ...
    created() {
        ...
        this.refreshListOwn() //LOAD INITIAL OF ACTIVITIES

        EventBus.$on('sendFilterOwn', data => { // IF USER USED TO FILTER
        ...
        EventBus.$on('selectedAnotherFilter', data => { // IF USER CHANGE OPTION FILTER
            this.activities     = []
            this.showCounters   = false
            this.showRowActions = false
        });

        EventBus.$on('refreshList',data => this.refreshList())
    ...
    methods: {
        refreshListOwn() {
            Vue.$toast.success("Actualizando lista...");
            this.isLoading = true
            let url = `${this.appUrl}api/users/${this.user_id}/activities-planned`;
