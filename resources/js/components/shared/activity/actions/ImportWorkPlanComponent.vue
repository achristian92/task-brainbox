            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-secondary">
                        Es recomendable descargar la plantilla base para importar las actividades.
...
export default {
    ...
    methods: {
        ...
        uploadFile() {
            ...
            let url = `${this.appUrl}api/users/${this.currentUser.id}/import-work-plan`
        ...
        downloadTemplate(e) {
            ...
            e.preventDefault();
            window.location =  `${this.appUrl}collaborator/my-planned/import`
        },
        reset() {
